...
/*
 frutas.filter(fruta => {
     ...
     else if(fruta.length===5){
        console.log(`${fruta} tiene 5 caracteres`)
     }
     else{
...
//SORT:Nos ordena el array alfabeticamente 
 ...
 //console.log(frutas.sort()) // Ascendente

 //console.log(frutas.sort().reverse()) // Descendente
//console.log(frutas)
